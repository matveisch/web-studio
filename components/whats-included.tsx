        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
            ...
            <p className="text-gray-500">
              A clean, modern, and easy-to-understand structure optimized for
          ...
          <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
            ...
            <p className="text-gray-500">
              We seamlessly incorporate your logo and brand colors.
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
            ...
            <p className="text-gray-500">
              We&apos;ll populate the page with your provided text and images.
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
            ...
            <p className="text-gray-500">
              An integrated form to capture visitor inquiries or leads.
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
            ...
            <p className="text-gray-500">
              Strategically placed buttons to guide user actions.
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
            ...
            <p className="text-gray-500">
              Essential on-page optimization (page title, meta description) to
